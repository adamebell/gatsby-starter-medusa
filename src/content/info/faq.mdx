...
<Expandable title={"How can I cancel or amend my order?"}>
  If your order hasn't shipped yet, just contact me as per the above and I can cancel your order in the backend. I won't capture your payment until the order is assembled, so there shouldn't be any issue with canceling it.
</Expandable>
